...
<html>
  ...
  <body bgcolor="LightYellow">
    <br>
    <form method="post" action="gbvideo3.php">
    Use title search for Great Britain videoes<br>
    ...
    <hr>
    <br>
    <form method="post" action="gbvideo2.php">
      Another search for Great Britain videoes<br>
