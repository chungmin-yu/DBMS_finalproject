...
<html>
  ...
  <body bgcolor="LightYellow">
    <br>
    <form method="post" action="jpvideo3.php">
    Use title search for Japan videoes<br>
    ...
    <hr>
    <br>
    <form method="post" action="jpvideo2.php">
      Another search for Japan videoes<br>
